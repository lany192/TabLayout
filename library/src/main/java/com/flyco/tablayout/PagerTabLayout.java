...
public class PagerTabLayout extends HorizontalScrollView {
    ...
    private void obtainAttributes(Context context, AttributeSet attrs) {
        ...
        mIndicatorStyle = ta.getInt(R.styleable.PagerTabLayout_tl_indicatorStyle, STYLE_NORMAL);
        mIndicatorColor = ta.getColor(R.styleable.PagerTabLayout_tl_indicatorColor, Color.parseColor(mIndicatorStyle == STYLE_BLOCK ? "#4B6A87" : "#ffffff"));
        mIndicatorHeight = ta.getDimension(R.styleable.PagerTabLayout_tl_indicatorHeight,
                DensityUtils.dp2px(mIndicatorStyle == STYLE_TRIANGLE ? 4 : (mIndicatorStyle == STYLE_BLOCK ? -1 : 2)));
        mIndicatorWidth = ta.getDimension(R.styleable.PagerTabLayout_tl_indicatorWidth, DensityUtils.dp2px(mIndicatorStyle == STYLE_TRIANGLE ? 10 : -1));
        mIndicatorCornerRadius = ta.getDimension(R.styleable.PagerTabLayout_tl_indicatorCornerRadius, DensityUtils.dp2px(mIndicatorStyle == STYLE_BLOCK ? -1 : 0));
        mIndicatorMarginLeft = ta.getDimension(R.styleable.PagerTabLayout_tl_indicatorMarginLeft, DensityUtils.dp2px(0));
        mIndicatorMarginTop = ta.getDimension(R.styleable.PagerTabLayout_tl_indicatorMarginTop, DensityUtils.dp2px(mIndicatorStyle == STYLE_BLOCK ? 7 : 0));
        mIndicatorMarginRight = ta.getDimension(R.styleable.PagerTabLayout_tl_indicatorMarginRight, DensityUtils.dp2px(0));
        mIndicatorMarginBottom = ta.getDimension(R.styleable.PagerTabLayout_tl_indicatorMarginBottom, DensityUtils.dp2px(mIndicatorStyle == STYLE_BLOCK ? 7 : 0));
        mIndicatorGravity = ta.getInt(R.styleable.PagerTabLayout_tl_indicatorGravity, Gravity.BOTTOM);
        mIndicatorWidthEqualTitle = ta.getBoolean(R.styleable.PagerTabLayout_tl_indicatorWidthEqualTitle, false);

        mUnderlineColor = ta.getColor(R.styleable.PagerTabLayout_tl_underlineColor, Color.parseColor("#ffffff"));
        mUnderlineHeight = ta.getDimension(R.styleable.PagerTabLayout_tl_underlineHeight, DensityUtils.dp2px(0));
        mUnderlineGravity = ta.getInt(R.styleable.PagerTabLayout_tl_underlineGravity, Gravity.BOTTOM);

        mDividerColor = ta.getColor(R.styleable.PagerTabLayout_tl_dividerColor, Color.parseColor("#ffffff"));
        mDividerWidth = ta.getDimension(R.styleable.PagerTabLayout_tl_dividerWidth, DensityUtils.dp2px(0));
     ...
     */
    public void setViewPager(ViewPager viewPager, CharSequence[] titles) {
     ...
     */
    public void setViewPager2(ViewPager2 viewPager2, CharSequence[] titles) {
