...
public class PagerTabLayout extends HorizontalScrollView {
    ...
    private void obtainAttributes(Context context, AttributeSet attrs) {
        ...
        mIndicatorWidth = ta.getDimension(R.styleable.PagerTabLayout_tl_indicator_width, DensityUtils.dp2px(mIndicatorStyle == STYLE_TRIANGLE ? 10 : -1));
        mIndicatorCornerRadius = ta.getDimension(R.styleable.PagerTabLayout_tl_indicator_corner_radius, DensityUtils.dp2px(mIndicatorStyle == STYLE_BLOCK ? -1 : 0));
        mIndicatorMarginLeft = ta.getDimension(R.styleable.PagerTabLayout_tl_indicator_margin_left, DensityUtils.dp2px(0));
        mIndicatorMarginTop = ta.getDimension(R.styleable.PagerTabLayout_tl_indicator_margin_top, DensityUtils.dp2px(mIndicatorStyle == STYLE_BLOCK ? 7 : 0));
        mIndicatorMarginRight = ta.getDimension(R.styleable.PagerTabLayout_tl_indicator_margin_right, DensityUtils.dp2px(0));
        mIndicatorMarginBottom = ta.getDimension(R.styleable.PagerTabLayout_tl_indicator_margin_bottom, DensityUtils.dp2px(mIndicatorStyle == STYLE_BLOCK ? 7 : 0));
        ...
        mUnderlineHeight = ta.getDimension(R.styleable.PagerTabLayout_tl_underline_height, DensityUtils.dp2px(0));
        ...
        mDividerWidth = ta.getDimension(R.styleable.PagerTabLayout_tl_divider_width, DensityUtils.dp2px(0));
        mDividerPadding = ta.getDimension(R.styleable.PagerTabLayout_tl_divider_padding, DensityUtils.dp2px(12));
        ...
        mTextUnselectColor = ta.getColor(R.styleable.PagerTabLayout_tl_textUnselectColor, Color.parseColor("#AAffffff"));
        ...
        mTabWidth = ta.getDimension(R.styleable.PagerTabLayout_tl_tab_width, DensityUtils.dp2px(-1));
        mTabPadding = ta.getDimension(R.styleable.PagerTabLayout_tl_tab_padding, mTabSpaceEqual || mTabWidth > 0 ? DensityUtils.dp2px(0) : DensityUtils.dp2px(20));
